...
GameOver.prototype.init = function () {
  ...
  var continueBtnKey = getResourceName('continue_btn')
  var continueBtnBitmapData = new LBitmapData(dataList[continueBtnKey])
  ...
  var gohomeBtnKey = getResourceName('gohome')
  var moreBtnBitmapData = new LBitmapData(dataList[gohomeBtnKey])
  ...
  var scoreTxt = window.GAME_LANG === 'en' ? 'Score: ' : '得分:'
  ...
  scoreTextField.text = scoreTxt + gScore.toString()
  ...
  // updateShare(gScore)
  // Play68.setRankingScoreDesc(gScore)
...
GameOver.prototype.onMoreBtnDown = function (event) {
  //clickMore();
  // Play68.goHome()
  window.parent.postMessage({ type: 'returnToApp', from: 'game' }, '*')
}
